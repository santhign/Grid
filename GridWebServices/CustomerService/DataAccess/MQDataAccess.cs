...
namespace CustomerService.DataAccess
{
    public class MQDataAccess
    {
        ...
        public async Task<ProfileMQ> GetDisplayUpdateMessageBody(int CustomerID, string MobileNumber)
        {
            try
            {
                ...
                _DataHelper = new DataAccessHelper("Customers_GetDisplayMessageQueue", parameters, _configuration);
